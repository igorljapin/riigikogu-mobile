...
| File | View | Theme |
|---|---|---|
| `01-parliament-light.png` | Parliament | light |
| `02-directory-light.png` | MP directory | light |
| `03-calculator-light.png` | Coalition calculator | light |
| `04-parliament-dark.png` | Parliament | dark |
| `05-directory-dark.png` | MP directory | dark |
| `06-calculator-dark.png` | Coalition calculator | dark |
